...
export const Message = () => {
    const [, , mszdata, setmszdata] = useContext(mszbtnContext);
    ...
    return <div style={{ maxWidth: '70%', margin: 'auto' }}>{mszdata && mszdata.map((elment) => <Personmsz key={elment.email} data={elment} handleOnClick={handleOnClick} />)}</div>;
};
